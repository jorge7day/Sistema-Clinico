                ...
                <f:form action="update.htm" modelAttribute="Pacientes" method="POST">
                    ...
                    <div class="row">
                        <div class="input-field col s4">
                            ...
                            <input type="text" name="idAfiliado" id="idAfiliado" value="${p.codClinica}"/>
                        </div>
                        ...
                        <div class="input-field col s4">
                            ...
                            <input type="text" name="nombre" id="nombreid" value="${p.telefono}"/>
                        </div>
                            
                        <div class="input-field col s4">
                            <label for="apellidoid">Direccion</label>
                            <input type="text" name="apellido" id="apellidoid" value="${p.direccion}"/>
                        </div> 
                    </div>
                    <div class="row">
                        <div class="input-field col s4">
                            <input id="direccion"  name="direccion" type="text" class="validate" value ="${p.departamento.codDepartamento}">
                            <label for="direccion">Departamento</label>
                        </div>
                        <div class="input-field col s4">
                            <input id="direccion"  name="direccion" type="text" class="validate" value ="${p.municipio.codMunicipio}">
                            <label for="direccion">Municipio</label>
                        </div>
                        <div class="input-field col s4">
                            <input id="direccion"  name="direccion" type="text" class="validate" value ="${p.departamento.nombre}">
                            <label for="direccion">Departamento</label>
                        </div>
                        <div class="input-field col s4">
                            <input id="direccion"  name="direccion" type="text" class="validate" value ="${p.departamento.nombre}">
