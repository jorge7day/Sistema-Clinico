                    ...
                    <div class="container">
                        <div class="row">
                            <div class="input-field col s4">
                                <label for="nickname">ID Usuario</label>
                                <input type="text" name="codUsuario" id="codUsuario" value="${p.codUsuario}"/>
                            </div>
                            <div class="input-field col s4">
                                <label for="nickname">Nickname</label>
                                <input type="text" name="nombreUsuario" id="nicknameid" value="${p.nombre}"/>
                            </div>
                            ...
                            <div class="input-field col s4">
                                ...
                                <input type="text" name="codRol" id="codRolid" value="${p.rol.codRol}"/>
                            </div> 
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                ...
                                <input id="codPersona" name ="codPersona" type="text" value="${p.persona.codPersona}">
