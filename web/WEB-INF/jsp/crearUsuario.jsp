...
<header>
  <div class="container "><a href="#" data-activates="nav-mobile" class="button-collapse top-nav waves-effect waves-light circle hide-on-large-only"><i class="material-icons">menu</i></a></div>
        <ul id="nav-mobile" class="side-nav fixed">
          ...
          <li class="bold active"><a href="getAllUsuarios.htm" class="waves-effect waves-teal"><i class="material-icons">book</i>Usuarios</a></li>
...
<f:form action="addUsers.htm" modelAttribute="Usuarios">
       ...
       <div class="input-field col s4">
        <label for="codUsuario">Correlativo</label>
          <input type="text" name="codUsuario" id="codUsuario" value=""/>
       </div>
       <div class="input-field col s4">
        <label for="nombreUsuario">Nickname</label>
          <input type="text" name="nombreUsuario" id="codUsuario" value=""/>
       </div>
    
       
       <div class="input-field col s4">
            <label for="contrasena">Contraseña</label>
          <input type="text" name="contrasena" id="passwordid" value=""/>
       </div>
    
        <div class="input-field col s4">
        <label for="rol">Rol</label>
          <input type="text" name="rol" id="codRolid" value=""/>
        </div> 
...
<!--    <i class="material-icons right">send</i>-->
       ...
       <a class="waves-effect waves-light btn red"  href="getAllUsuarios.htm"><i class="material-icons left ">person_add</i>Cancelar</a>
